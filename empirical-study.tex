...
Before we start to develop approaches to solve the naming problem, it is more important to understand how developers name their unit tests in a real world scenario.
%
...
%
Although the main focus of the study is designed for checking if the tests are named after what makes them unique, the collected results also indicate different test names could be constructed from different naming rationales but they should all be considered as \enquote{good}.
