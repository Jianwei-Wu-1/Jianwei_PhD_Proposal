...
\toprule
 & \multicolumn{3}{c}{\textbf{Full}} & \multicolumn{3}{c}{\textbf{Partial}} & \multicolumn{1}{c}{\textbf{None}}\\
\cmidrule(lr){2-4}
\cmidrule(lr){5-7}
\cmidrule(lr){8-8}

\multicolumn{1}{c}{\textbf{Project}} & \multicolumn{1}{c}{\textbf{\# Tests}} & \multicolumn{1}{c}{\textbf{Identical}} & 
