...
As mentioned in~\cref{sec:empStudy}, we found out that developers often prefer to use different methods and naming rationales to construct a descriptive test name.
%
Another important method for constructing descriptive test names is based on the descriptiveness of the test, which is to extract descriptive information from the test name and body and use the extracted information to conduct a information comparison to detect and improve non-descriptive test names.
%
For the second part of work, I consider a pattern-based approach that can help developers identify and improve non-descriptive test names using the extracted descriptive information from those tests.
%
This part of work focuses on solving the naming problem from another important method that is to summarize the descriptive information from the test body and compare it with the information from the test name.
%
...
After knowing how to detect and improve non-descriptive test names, we will move on to the last method of providing descriptive test name, which is based on the shape of the test.
%
Similarly, we will conduct an empirical study to investigate how the shape of test names and bodies affects developer's comprehension of the corresponding unit tests.
