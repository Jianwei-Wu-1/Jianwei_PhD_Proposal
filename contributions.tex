...
%
Besides the preliminary work, I first plan to use the results from the empirical study to develop a uniqueness-based approach that can generate descriptive names for JUnit tests.
%
...
\begin{enumerate}
    ...
    \item a novel, uniqueness-based approach that can generate descriptive test names by a uniqueness-based naming rationale
...
I anticipate that my research can systematically help test developers to identify non-descriptive test names and improve them using the pattern-based approach or replace them using the uniqueness-based approach.
%
