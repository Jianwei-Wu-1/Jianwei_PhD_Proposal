\section{A Concept-based Approach to Improve Test Names with Uniqueness based Naming Rationale}
\label{sec:unique-test-name}

In the second part of work, I consider investigating if tests are named after what makes them unique, and create a concept-based approach that can provide a uniqueness-based naming rationale for developers.
%
...
As the empirical study is successfully completed, the next step will be the implementation and evaluation of the concept-based approach, which is the first part of my planned remaining work.