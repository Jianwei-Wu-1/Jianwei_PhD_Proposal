...
% TODO[fixed]: Can you provide a better organization of these?  Something like 1) approaches for suggesting improvements 2) Approaches for generating names.  Right now, you switch between the two.
...
% TODO[fixed]: You need a better connection between prior work and what you are proposing. Why are these previous approach together not good enough? Before talking about the steps in detail, you should present a high-level overview (i.e, the approach figure.)
Although existing approaches performed well on both providing useful suggestions to improve poor names or generating better names, they did not focus on providing descriptive test names from a uniqueness-focused perspective.
%
...
%
\Cref{fig:all-research} shows an overview of my dissertation work.
%
...
The second step of my dissertation work is to develop a systematic approach to generate descriptive test names.
%
