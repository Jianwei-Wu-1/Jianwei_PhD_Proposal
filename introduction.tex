...
% TODO[done, change for all]: They are not necessity unique test names (except among tests in the same class) but are names based on what makes the test unique.
...
Consequently, for the first part of my planned future work, I propose a novel, uniqueness-based approach that can:
%
\begin{enumerate*}
