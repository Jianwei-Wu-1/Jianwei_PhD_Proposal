...
Because non-descriptive test names negatively impact software development, there have been several attempts to address this issue. % POOR TEST NAMES
% Unit testing
...
% TODO[added]: Is there other work that goes here?
...
% TODO[fixed] What is the study of?
...
% TODO[fixed] Describe second component.
...
The final component will be a new approach for generating descriptive names based primarily on the unique attributes identified by the tool created in the second component.
%
