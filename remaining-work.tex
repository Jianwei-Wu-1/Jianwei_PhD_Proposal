...
% TODO[fixed]: I don't know what you mean by cognition here.  Based primarily on unique attributes and meets with developer approval?
...
%TODO[fixed]: Describe how this component will complete the second piece of work
...
% TODO[moved to plan section]: These sections should be integrated with the research plan section.


\subsubsection{Research Plan}

% TODO[fixed]: This could use some better structure.  Each step should be an individual paragraph and expanded with a bit more information.
...
%TODO[]: It would help to restrucutre this part
% Have a subsubsection for ``subjects'' explain what you will use and why.
% Have a subsubection for RQ1.  Explain the question, why it is interesting, the methodology for answering it (data generaton), how you will determine the answer
% Have a subsubection for RQ2.  Explain the question, why it is interesting, the methodology for answering it (data generaton), how you will determine the answer
%TODO: For q2 it would help to show a tentative survey or at least some example questions.
